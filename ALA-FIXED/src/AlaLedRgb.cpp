...
AlaLedRgb::AlaLedRgb()
{
    ...
    pxPos = malloc(sizeof (float)); //din2949
	pxPos = NULL;
	pxSpeed = malloc(sizeof (float)); //din2949
    pxSpeed = NULL;
}
...
void AlaLedRgb::initPWM(int numLeds, byte *pins)
{
    ...
    byte *pins_ = (byte *)malloc(numLeds*3); //din2949
     for(int x=0; x<numLeds*3; x++) {  //din2949
		 pins_[x] = pins[x]; //din2949
	 } //din2949
	this->driver = ALA_PWM;
...
{
//Serial.println("setanim num of colors1: " + String(palette.colors[0].r)); //good values here
//Serial.println("setanim num of colors2: " + String(palette.colors[0].g));
//Serial.println("setanim num of colors3: " + String(palette.colors[0].b));
	...
	this->palette.colors = (AlaColor*)malloc(3*palette.numColors+1); //din2949
    for (int x=0; x<palette.numColors; x++) { //din2949
		this->palette.colors[x] = palette.colors[x]; //din2949	
	} //din2949
	this->palette.numColors = palette.numColors; //din2949
...
//Serial.println("color1: " + String(this->palette.colors[0].r)); //din2949
//Serial.println("color2: " + String(this->palette.colors[0].g));
//Serial.println("color3: " + String(this->palette.colors[0].b));
//Serial.println("color4: " + String(this->palette.colors[1].r));
//Serial.println("color5: " + String(this->palette.colors[1].g));
//Serial.println("color6: " + String(this->palette.colors[1].b));
//Serial.println("color7: " + String(this->palette.colors[2].r));
//Serial.println("color8: " + String(this->palette.colors[2].g));
//Serial.println("color9: " + String(this->palette.colors[2].b));
